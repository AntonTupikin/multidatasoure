...
public class EmployeeService {
    ...
    public EmployeeProfile getByIdAndUser(Long id, User user) {
        return employeeProfileRepository.findById(id).orElseThrow(() -> new UsernameNotFoundException("User not found: " + id));
    }
}